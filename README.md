...
This toolchain targets the AArch32, AArch64 and x86 architectures.
...
This toolchain is built on Ubuntu 20.04 focal, which uses glibc 2.38. Compatibility with older distributions cannot be guaranteed. Other libc implementations (such as musl) are not supported.
