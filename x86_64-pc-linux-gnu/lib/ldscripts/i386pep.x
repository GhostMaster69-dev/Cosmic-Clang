...
SEARCH_DIR("/workspace/tc-build-1/install/x86_64-pep/lib"); SEARCH_DIR("/workspace/tc-build-1/install/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
